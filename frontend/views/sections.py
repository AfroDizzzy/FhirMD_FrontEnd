...
def sections(request):
    ...
    # TODO: This needs to be done on startup of backend, currently computes for every request sent to the server.
    ...
    return render(request, 'frontend/sections.html', context)